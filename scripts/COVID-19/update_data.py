...
if __name__ == "__main__":
    ...
    t_headers = [
        normalize_keyword(header.text.encode("utf-8", "ignore"))
    ...
    for row in table.find_all("tr"):
        t_rows.append(
            [
                normalize_keyword(val.text.encode("utf-8", "ignore"))
    ...
    wom_data_df = wom_data_df[
        wom_data_df["Country,Other"].isin(
            [
                "",
                None,
                "North America",
    ...
    graphs.growth_rate(
        ...
        10,
        "cases",
        root_path + "/COVID-19/charts/cases_growth",
