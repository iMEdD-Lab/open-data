...
def create_regions_facets(name, regions_greece_deaths_data, show=False):
    ...
    fig.update_layout(
        ...
        paper_bgcolor="#E6ECEC",
        plot_bgcolor="#E6ECEC",
        title=dict(text="<br>Εξέλιξη θανάτων ανά Περιφέρεια<br>", font=TEXTFONT),
        margin=dict(r=50, b=70, t=100, pad=0),
        hoverlabel=dict(font_size=8, font_family="Roboto"),
        yaxis3_title=dict(
            text="<i>θάνατοι συνολικά</i>",
    ...
    fig.update_layout(
        ...
        annotations=[
            dict(
                ...
                xref="paper",
                yref="paper",
                text="<i>Η τιμή κάθε ημέρας είναι ο μέσος όρος <br>των ρυθμών αύξησης των τελευταίων επτά ημερών</i>",
                showarrow=False,
                align="left",
            )
        ],
